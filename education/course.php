<?php
class FormCourse{
	public function FormCourseShow($userDat,$userPerson,$userWatch,$ListItems){
	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main" style="padding-top:5%;">
            <div class="col-md-8" align="center" align-content="center">
             <h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft"><span>CURSOS</span></h2>   
            </div>
            <div>
                <div>
				    ...
				    for($i=0;$i<$viewSize;$i++){
				        ...
				        <div class="col-md-12 col-sm-6 col-xs-6 col-xxs-12 work-item">
                            <form action="Option/option.php" method="POST">
                            	...
                            	<input type="hidden" name="option" value="Courses">
