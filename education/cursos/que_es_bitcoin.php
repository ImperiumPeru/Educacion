				...
				<div class="row">
					...
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						...
						<figure class="text-center">
							<iframe style="max-width:100%" width="1200px"; height="550px"; src="https://www.youtube.com/embed/S2HxMK7iO4c?rel=0&showinfo=0?rel=0&amp;autoplay=1 " frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>	
						</figure>
					</div>
					...
					<div class="col-md-8 col-md-offset-2 animate-box" data-animate-effect="fadeInLeft">
						...
						<div style="text-align: justify">
							...
							<h1></br>Algunas características </br> de Bitcoin:</h1>
							
							<p> 
								<ol>
								<li type="disc"> No pertenece a ningún Estado o país y puede usarse en todo el mundo por igual.  
								<li type="disc"> Puedes comprar bitcoins con euros u otras  divisas y viceversa, como cualquier moneda. 
								<li type="disc"> No hay intermediarios: Las transacciones se hacen directamente de persona a persona.
								<li type="disc"> <strong> Es descentralizada:</strong> no es controlada por ningún  Estado, banco, institución financiera o &nbsp &nbsp &nbspempresa.
								<li type="disc"> Es imposible su falsificación o duplicación gracias a un sofisticado sistema criptográfico.
								<li type="disc"> Las transacciones son irreversibles.
								<li type="disc"> No es necesario revelar tu identidad al hacer negocios y preserva tu privacidad.
								<li type="disc"	> El dinero te pertenece al 100%; no puede ser intervenido por nadie ni las cuentas pueden ser congeladas.</p>
								</ol>
							<h1> Bitcoin es Justo</h1>
								<p>
									En muchos sistemas tradicionales nos encontramos que enviar dinero 
									es mucho más fácil que recibirlo. Esto dificulta la creación de nuevos
									negocios y tiendas online. Sin embargo, con Bitcoin, ambas opciones 
									son igual de sencillas y cualquiera puede enviar y recibir dinero sin 
									ningún tipo de restricción. Además, si eres dueño de un negocio, tanto
									digital como físico, no cuesta nada empezar a aceptar bitcoins.
								</p>

							<h1> ¿Es Bitcoin legal? </h1>
								<p>
									La legalidad de Bitcoin es sencilla de resumir </br><strong> "Bitcoin es legal </strong>  en aquel 
									lugar que la acepten como medio de pago en una transacción <strong>” </strong>, así de fácil 
									y sencillo. Al estar fuera de control de cualquier institución existe un vacío
									 legal sobre ella. </br>
										
									Además, al tratarse de transacciones anónimas y cifradas entre dos usuarios, 
									están libres de cualquier comisión o impuesto como, por ejemplo, el IVA.
								</p>


								<h1> ¿Cómo conseguir Bitcoin?</h1>
									<p>
									Existen tres formas de conseguir o comprar Bitcoins. La primera, y más sencilla,
									 es accediendo a alguno de los mercados de Bitcoin como <a href="https://localbitcoins.com" target="blank"> LocalBitcoin</a>  o <a href="https://www.buda.com/" target="blank">Buda</a>  , que
									 permiten intercambiar dinero convencional, euros o dólares, por Bitcoin.
									
									Otra forma es el intercambio de bienes con otros usuarios, es decir, 
									la compra/venta de toda la vida pero pagando con Bitcoins. La última, y 
									más extraña, es la “minería”. Esta práctica consiste en utilizar parte de 
									los recursos de nuestro ordenador en la resolución de problemas matemáticos
